      ...
      <div className="flex-1 flex flex-col px-5 sm:px-6 md:px-8 pt-12 sm:pt-14 pb-24 max-w-lg mx-auto w-full">
        ...
        <div className="mt-6">
          <textarea
            ...
            className="w-full h-48 sm:h-56 p-4 bg-transparent border border-accent text-foreground placeholder-secondary/70 resize-none focus:outline-none focus:border-foreground transition-colors font-mono text-sm"
          />
        </div>
